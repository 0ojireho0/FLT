...
use App\Models\RegularEnglishModule;
use Illuminate\Support\Facades\Storage;

class RegularEnglishModuleController extends Controller
{
    //
    ...
    {
        $pdf = RegularEnglishModule::find($id);
    ...
    {
        //
        $pdf = RegularEnglishModule::findOrFail($id);
