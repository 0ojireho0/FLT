...
use App\Models\LS3Mathematical;
use Illuminate\Support\Facades\Storage;

class LS3MathematicalController extends Controller
{
    //
    ...
    {
        //
        $pdf = LS3Mathematical::findOrFail($id);
