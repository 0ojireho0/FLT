...
use App\Models\LS2ScientificLiteracy;
use Illuminate\Support\Facades\Storage;

class LS2ScientificLiteracyController extends Controller
{
    //
    ...
    {
        $pdf = LS2ScientificLiteracy::find($id);
    ...
    {
        //
        $pdf = LS2ScientificLiteracy::findOrFail($id);
